...
alias update="sudo apt-get update && sudo apt-get -f -y upgrade && sudo apt-get -f -y dist-upgrade && sudo apt-get -f -y dselect-upgrade"
alias Tor="service tor start && service privoxy start"
